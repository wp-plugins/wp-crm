...
class class_contact_messages {
  ...
  function init() {
    ...
    add_action("admin_menu", array('class_contact_messages', "admin_menu"));
...
/**
  ...
  function settings_page_tab_content($wp_crm) {
    ...
    if(empty($wp_crm['wp_crm_contact_system_data'])) {
      ...
      $wp_crm['wp_crm_contact_system_data']['example_form']['slug'] = '[wp_crm_form form=example_contact_form]';
